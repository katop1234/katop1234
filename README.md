...
- 🎓 [SPDER](https://github.com/katop1234/spder) — Semiperiodic Damping-Enabled Object Representation. Accepted ICLR 2024 (poster).
- 🏹 [Artemis](https://github.com/katop1234/artemis) — a novel line search-based optimizer designed for extremely long rollouts that can jointly optimize neural networks with scalar hyperparameters. Competitive with state-of-the-art black box optimizers NES/CMA-ES.
...
- 📄 [Resume Feedback Assistant](https://github.com/katop1234/resume_feedback) — takes a resume + job description and returns exactly what to change to pass the screen.
